...
class MedicamentoController {
  async getAll(req: Request, res: Response) {
    try {
      const medicamentos = await AppDataSource.getRepository(
        Medicamento
      ).find();
  ...
  async getById(req: Request, res: Response) {
    try {
      ...
      const medicamento = await AppDataSource.getRepository(
        Medicamento
      ).findOne({
        where: { id },
      });
  ...
  async delete(req: Request, res: Response) {
    try {
      const id = parseInt(req.params.id, 10);
      const deleteResult = await AppDataSource.getRepository(
        Medicamento
      ).delete(id);
